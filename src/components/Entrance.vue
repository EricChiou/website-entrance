    ...
    websites: [
      {
        ...
        content:
          '該來的終於還是來啦！我們的婚禮將於 2019/11/23 舉辦，歡迎大家來參加喔～\n這是電子喜帖的連結。',
        shortContent: '我們婚禮將於 2019/11/23 舉辦，歡迎大家來參加喔～',
        icon: null,
      },
      {
